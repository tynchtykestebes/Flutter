import 'package:bilimduu_zhashtar_tapshyrma_2/second_page.dart';
        ...
        child: Column(
          ...
          Container(
            ...
            IconButton(onPressed: () {
              //экинчи бетке откондо secondPageIndex биринчи беттеги index-ти алат
              Navigator.push(context, MaterialPageRoute(builder: (context) =>
              SecondPage(secondPageIndex: index,) ));
